...
public class SoulMarshmallowOnAStickItem extends Item {

    public SoulMarshmallowOnAStickItem(Properties p_41383_) {
        super(p_41383_);
    ...
    public void inventoryTick(ItemStack stack, Level level, Entity entity, int slot, boolean held) {
        ...
        if (tag.getInt("Roastedness") < 50 && rand.nextFloat() > 0.75F && held && lookAt((Player) entity, rt.getBlockPos(), 0.3D) && (level.getBlockState(rt.getBlockPos()).is(Blocks.SOUL_CAMPFIRE))) {
